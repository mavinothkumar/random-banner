...
function bc_rb_enqueue() {
	...
	if ( isset( $get_payload['page'] ) &&
		 ( 'bc_random_banner' === $get_payload['page'] ||
		   'bc_random_banner_support' === $get_payload['page'] ||
		   'bc_random_banner_option' === $get_payload['page'] ||
		   'bc_random_banner_campaign' === $get_payload['page'] ||
		   'bc_random_banner_statistics' === $get_payload['page']
		 )
	) {
