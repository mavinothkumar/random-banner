...
function bc_rb_db_update( $old_version ) {
	...
	bc_rb_version_2_0_to_2_2();
	bc_rb_version_2_2_greater();
	bc_rb_version_3_3();
}
...
function bc_rb_update_from_old() {
	...
	bc_rb_random_banner_table_create( $bc_random_banner, $charset_collate );
	bc_rb_random_banner_option_table( $bc_random_banner_options, $bc_random_banner, $charset_collate );
 ...
 */
function bc_rb_random_banner_table_create( $bc_random_banner, $charset_collate ) {
	global $wpdb;
