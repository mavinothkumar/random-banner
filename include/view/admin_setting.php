	...
	<div class="bc_rb container bc_random_banner" data-display_name="<?php echo esc_attr( bc_rb_get_user_display_name() ); ?>">
		<div class="row">
			<div class="col-md-7 p-20">
				<div class="btn-group">
					...
					<?php _e( 'Add New Banner', 'random-banner' ); ?>
			...
			<div class="col-md-5 p-10">
				...
				<div class="col-md-7 bc_plugin_demo" data-email="<?php echo esc_attr( bc_get_current_user_email() ); ?>">
					<div class="flex table-bordered p-10">
						<div class="p-r-20">
							<img src="<?php echo esc_url( plugins_url( 'assets/images/demo.png', BC_RB_PLUGIN ) ); ?>"/>
						</div>
		...
		<div class="row">
			<div class="col-md-5 bc_filters hide">
				<div class="bc_filter_by"><?php _e( 'Filter By', 'random-banner' ); ?></div>
				<div>
...
function bc_random_banner_option() {
	...
	<div class="bc_rb container bc_random_banner" data-display_name="<?php echo bc_rb_get_user_display_name(); ?>">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>
					<?php _e( 'Random Banner Settings', 'random-banner' ); ?>
		...
		<div id="content" class="padding_top_20">
			<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
				<li class="active">
					<a href="#category" data-toggle="tab"><?php _e( 'Category', 'random-banner' ); ?></a>
				</li>
				<li>
					<a href="#post_page" data-toggle="tab"><?php _e( 'Insert Banners inside the Post/Page', 'random-banner' ); ?></a>
				</li>
				<li>
					<a href="#Popup" data-toggle="tab"><?php _e( 'Popup', 'random-banner' ); ?></a>
				</li>
				<li>
					<a href="#Statistics" data-toggle="tab"><?php _e( 'Statistics', 'random-banner' ); ?></a>
				</li>
				<li>
						<a href="#FloatingAds" data-toggle="tab"><?php _e( 'Floating Ads', 'random-banner' ); ?></a>
					</li>
				<li>
					<a href="#Others" data-toggle="tab"><?php _e( 'Others', 'random-banner' ); ?></a>
				</li>
			</ul>
						...
						<div class="row">
							<div class="col-md-12 p-b-20">
								<button class="btn btn-primary new_category">
									<span class="glyphicon glyphicon-plus"></span>
									<?php _e( 'Add New Category', 'random-banner' ); ?>
								</button>
							</div>
					...
					<div class="col-md-7">
						...
						<div class="bc_rb_insert_post_shortcode padding_top_20">
							<div class="bc_rb_check_insert_post">
								<h4><?php _e( 'Enable Banner to all Post and Pages?', 'random-banner' ); ?></h4>
							...
							<div class="row bc_rb_enable_insert_post_shortcode hide">
								<div class="col-md-6">
									<h4><?php _e( 'Category Name', 'random-banner' ); ?></h4>
			...
			<div class="tab-pane p-20" id="Popup">
				...
				<div class="row padding_top_20">
					<div class="col-md-3">
						<?php _e( 'Enable Popup?', 'random-banner' ); ?>
					</div>
					<div class="col-md-4">
				...
				<div class="row padding_top_20">
					<div class="col-md-3">
						<?php _e( 'Category to show in Popup', 'random-banner' ); ?>
					</div>
					<div class="col-md-4">
						<?php
				...
				<div class="margin_20 paypal_donation_button">
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'How many times Popup should show per Session?', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
					...
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'Popup should show after', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
					...
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'Popup Loading Animated Style', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
							<?php
							echo bc_rb_drop_down(
					...
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'Enable Popup Background Transparent', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
					...
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'Popup Background Color', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
					...
					<div class="row padding_top_20">
						<div class="col-md-3">
							<?php _e( 'Popup Border Color', 'random-banner' ); ?>
						</div>
						<div class="col-md-4">
				...
				<div class="padding_top_10">
					<button type="submit" name="bc_rb_popup_save" class="btn btn-primary bc_rb_popup_save"><?php _e( 'Save', 'random-banner' ); ?></button>
				</div>
				</form>
			</div>
			<div class="tab-pane p-20 paypal_donation_button" id="Statistics">
				<div class="row">
					<div>
						<div class="row padding_top_20">
							<div class="col-md-3">
								<?php _e( 'Google Map API Key', 'random-banner' ); ?>
							</div>
							<div class="col-md-5">
				...
				<div class="row padding_top_200">
					<div class="bg-danger p-20">
						<div class="row padding_top_20">
							<div class="col-md-3">
								<?php _e( 'Total Number of row in Statistics', 'random-banner' ); ?>
							</div>
						...
						<div class="row padding_top_20">
							<div class="col-md-3">
								<?php _e( 'Delete last __ records from statistics', 'random-banner' ); ?>
							</div>
							<div class="col-md-4">
								<?php
								echo bc_rb_drop_down(
						...
						<div class="row padding_top_20">
							<div class="col-md-6">
								<button type="submit" name="bc_rb_option" class="btn btn-danger bc_rb_statistic_delete">
									<?php _e( 'Delete Records', 'random-banner' ); ?>
								</button>
							</div>
						</div>
					</div>
			...
			<div class="tab-pane p-20" id="Others">
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<?php _e( 'Open Ads Link in New Window', 'random-banner' ); ?>
					</div>
					<div class="col-md-4">
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<?php _e( 'Currency Type', 'random-banner' ); ?> [Pro Version]
					</div>
					<div class="col-md-3">
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<?php _e( 'Disable Banners to Logged in Users?', 'random-banner' ); ?>
					</div>
					<div class="col-md-4">
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<span class="danger_fonts"><?php _e( 'Disable Random Banner for Mobile and Tablets?', 'random-banner' ); ?> [Pro Version]</span>
						<br>
						<i>
						<?php
						_e(
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						...
						<?php
						_e( 'Disable Random Banner in all location in that page when Post/Page banner disabled [Pro Version]', 'random-banner' );
						?>
						</span>
					</div>
					<div class="col-md-6">
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<span class="danger_fonts"><?php _e( 'Disable Random Banner in all locations', 'random-banner' ); ?></span>
						<br>
						<i>
						<?php
						_e(
				...
				<div class="row padding_top_20">
					<div class="col-md-6">
						<?php _e( 'Text for empty banner', 'random-banner' ); ?>
						<br>
						<i>
						<?php
						_e(
...
function bc_random_banner_campaign() {
    ...
    <div class="bc_rb container">
        ...
        ';
	echo '
        <div class="bc_random_banner_campaign" data-display_name="' . bc_rb_get_user_display_name() . '" data-url="' . esc_url( admin_url( 'admin-ajax.php?action=bc_rb_save_campaign&nonce=' . wp_create_nonce( ' bc_rb_save_campaign' ) ) ) . '" >';
...
function bc_rb_disable_random_banner( $post ) {
	...
	?>
	<p>
		<label for="bc_rb_disable_banner"><?php _e( 'Disable Random Banner?', 'random-banner' ); ?></label>
		<input type="checkbox"
			   name="bc_rb_disable_banner"
			   id="bc_rb_disable_banner"
			   value="yes" <?php echo esc_attr( $checked ); ?> />
	</p>
	<p class="description">
		<?php _e( 'If you wish to disable random banner on this content, please check this option.', 'random-banner' ); ?>
	</p>
	<?php
}
...
<div class="bc_rb_close"><img src="' . esc_url(plugins_url( 'assets/images/close.png', BC_RB_PLUGIN )) . '" /></div>
