...
require_once BC_RB_PLUGIN_DIR . '/include/view/admin-setting.php';
require_once BC_RB_PLUGIN_DIR . '/include/validation/random-banner.php';
require_once BC_RB_PLUGIN_DIR . '/include/controller/populate-content.php';
require_once BC_RB_PLUGIN_DIR . '/include/controller/save-update-delete.php';
require_once BC_RB_PLUGIN_DIR . '/include/widget/random-banner-widget.php';
